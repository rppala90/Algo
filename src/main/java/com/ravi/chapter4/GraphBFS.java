...
7) In Garbage Collection: Breadth First Search is used in copying garbage collection using Cheney’s algorithm. Refer this and for details.
...
Many algorithms like Prim’s Minimum Spanning Tree and Dijkstra’s Single Source Shortest Path use structure similar to Breadth First Search.
  ...
  public void bfs(GraphNode node) {
    ...
    while(! q.isEmpty()) {
      ...
      current.children.forEach((x) -> { if(x.visited == false) q.add(x);});
    }
  }
